...
static class InfoText {
    ...
    public static animalDescription[] getDescriptions() {
        animalDescript = new animalDescription[]
        {
			...
			new animalDescription { name = "Cokes_hartebeest", displayName = "", gender = "InfoGenderMale", conservation = "",  map = "T_Map_BohorReedbuck", maxCount = 1},
			new animalDescription { name = "Common_Eland", displayName = "", gender = "InfoGenderMale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 1},
			...
			new animalDescription { name = "Roan", displayName = "Roan", gender = "InfoGenderMale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 36},
			new animalDescription { name = "Roan_F", displayName = "Roan", gender = "InfoGenderFemale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 36},
			new animalDescription { name = "Sable", displayName = "Sable", gender = "InfoGenderMale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 18},
