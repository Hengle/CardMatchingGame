...
static class InfoText {
    ...
    public static animalDescription[] getDescriptions() {
        animalDescript = new animalDescription[]
        {
			...
			new animalDescription { name = "GiantEland", displayName = "Giant Eland", gender = "InfoGenderMale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 1},
			new animalDescription { name = "GiantEland_F", displayName = "Giant Eland", gender = "InfoGenderFemale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 1},
			...
			new animalDescription { name = "HuntersAntelope_F", displayName = "Hunter's Antelope", gender = "InfoGenderFemale", conservation = "Critically Endangered",  map = "T_Map_BohorReedbuck", maxCount = 3},
			...
			new animalDescription { name = "MountainNyala", displayName = "Mountain Nyala", gender = "InfoGenderMale", conservation = "Endangered",  map = "T_Map_BohorReedbuck", maxCount = 3},
			new animalDescription { name = "MountainNyala_F", displayName = "Mountain Nyala", gender = "InfoGenderFemale", conservation = "Endangered",  map = "T_Map_BohorReedbuck", maxCount = 3},
			new animalDescription { name = "NileLechwe", displayName = "Nile Lechwe", gender = "InfoGenderMale", conservation = "Endangered",  map = "T_Map_BohorReedbuck", maxCount = 3},
			new animalDescription { name = "NileLechwe_F", displayName = "Nile Lechwe", gender = "InfoGenderFemale", conservation = "Endangered",  map = "T_Map_BohorReedbuck", maxCount = 3},
			...
			new animalDescription { name = "Sable_F", displayName = "Sable Antelope", gender = "InfoGenderFemale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 18},
			new animalDescription { name = "SlenderhornedGazelle", displayName = "Slender-horned Gazelle", gender = "InfoGenderMale", conservation = "Endangered",  map = "T_Map_BohorReedbuck", maxCount = 1},
			...
			new animalDescription { name = "Waterbuck_F", displayName = "Waterbuck", gender = "InfoGenderFemale", conservation = "Least Concern",  map = "T_Map_BohorReedbuck", maxCount = 51},
